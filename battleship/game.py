...
class Game:
    ...
    def play(self):
        ...
        while not self.player1.has_lost() and not self.player2.has_lost():
            ...
            while is_ship_hit is None or is_ship_hit:
                ...
                is_ship_hit, has_ship_sunk  = opponent.board.is_attacked_at(target_cell)
    ...
    def show_opponent_board(self, opponent, attacker):  
        ...
        Args:
            ...
            attacker (Player)
        """    
        print(f"Here is the current state of {opponent}'s board before {attacker}'s attack:\n")
    ...
    def announce_turn_outcome(self, attacker, opponent, is_ship_hit, 
        ...
        """                              
        if has_ship_sunk:
            print(f"\nA ship of {opponent} HAS SUNK. {attacker} can play another time.")
        elif is_ship_hit:
            print(f"\nA ship of {opponent} HAS BEEN HIT. {attacker} can play another time.")
        else:
            print("\nMissed".upper())
